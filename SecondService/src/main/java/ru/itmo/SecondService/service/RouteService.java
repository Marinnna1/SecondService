...
public class RouteService {
    ...
    public Long getRoutesCount() throws CertificateException, UnrecoverableKeyException, NoSuchAlgorithmException, IOException, KeyManagementException, KeyStoreException {
        final String uri = "https://localhost:8086/routes/count";
        return requestService.sendRequest(uri, HttpMethod.GET, null, Long.class);
    }
